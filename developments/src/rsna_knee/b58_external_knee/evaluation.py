...
def evaluate(root, reference_root):
    ...
    result = {"version": VERSION, "rsna_identity": p["rsna_identity"],
              "reference": "B57 dinov2_slice_candidate", "candidate": "B58 mixed-source adaptation",
              "automatic_promotion_or_submission": False,
              "interpretation": "reused development comparison; extra SSL and external images change together; confirm independently"}
